...
import di2 from "../../images/discover2.png";
import di3 from "../../images/discover3.png";
import di5 from "../../images/discover5.png";
import di6 from "../../images/discover6.png";
    ...
    return (
        <section className='discover'>
            <div className="container">
                ...
                <div className='discover__cover'>
                    <button> Recently added</button>

                    <ul className='discover__lists'>
                        <li className='discover__list'> All items </li>
                        <li className='discover__list'> Art </li>
                        <li className='discover__list'> Game </li>
                        <li className='discover__list'> Photography </li>
                        <li className='discover__list'> Music </li>
                        <li className='discover__list'> Video </li>
                    </ul>
                ...
                <ul className='hotbid__card'>
                    ...
                    <li className='hotbid__card-first'>
                        <div className='hotbid__uper'>
                            <img className='hotbid__image' src={di} alt=''/>
                        </div>
                    ...
                    <li className='hotbid__card-first'>
                        <div className='hotbid__uper'>
                            <img className='hotbid__image' src={di2} alt=''/>
                        </div>
                    ...
                    <li className='hotbid__card-first'>
                        <div className='hotbid__uper'>
                            <img className='hotbid__image' src={di3} alt=''/>
                        </div>
                    ...
                    <li className='hotbid__card-first'>
                        <div className='hotbid__uper'>
                            <img className='hotbid__image' src={di5} alt=''/>
                        </div>
                ...
                <ul className='discover__card'>
                    ...
                    <li className='hotbid__card-first'>
                        <div className='hotbid__uper'>
                            <img className='hotbid__image' src={di6} alt=''/>
                        </div>
                ...
                <button className='discover__button'>Learn more</button>
